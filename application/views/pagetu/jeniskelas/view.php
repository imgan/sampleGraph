                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" id="e_nama_kelas" name="e_nama_kelas" id="form-field-1" placeholder="Biologi" class="form-control" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    if ($("#formTambah").length > 0) {
        $("#formTambah").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('modultu/jeniskelas/simpan') ?>",
                    type: "POST",
    ...
    if ($("#formEdit").length > 0) {
        $("#formEdit").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('modultu/jeniskelas/update') ?>",
                    type: "POST",
...
<script type="text/javascript">
    ...
    function show_data() {
        $.ajax({
            type: 'POST',
            url: '<?php echo site_url('modultu/jeniskelas/tampil') ?>',
            async: true,
            dataType: 'json',
    ...
    $('#show_data').on('click', '.item_edit', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('modultu/jeniskelas/tampil_byid') ?>",
            async: true,
            dataType: "JSON",
            data: {
                id: id,
    ...
    $('#show_data').on('click', '.item_hapus', function() {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('modultu/jeniskelas/delete') ?>",
                    async: true,
                    dataType: "JSON",
                    data: {
                        id: id,
