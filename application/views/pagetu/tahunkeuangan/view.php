    ...
    if ($("#formTambah").length > 0) {
        $("#formTambah").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('modultu/tahunkeuangan/simpan') ?>",
                    type: "POST",
    ...
    if ($("#formEdit").length > 0) {
        $("#formEdit").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('modultu/tahunkeuangan/update') ?>",
                    type: "POST",
...
<script type="text/javascript">
    ...
    function show_data() {
        $.ajax({
            type: 'POST',
            url: '<?php echo site_url('modultu/tahunkeuangan/tampil') ?>',
            async: true,
            dataType: 'json',
    ...
    $('#show_data').on('click', '.item_edit', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('modultu/tahunkeuangan/tampil_byid') ?>",
            async: true,
            dataType: "JSON",
            data: {
                id: id,
