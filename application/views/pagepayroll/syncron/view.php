        ...
        <div class="widget-box transparent" id="widget-box-12">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="smaller lighter blue no-margin">Form Import Data Finger Print</h3>
                </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <form class="form-horizontal" role="form" enctype="multipart/form-data" id="formImport">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <a href="<?php echo base_url().'assets/finger.xlsx' ?>" class="col-sm-3" for="form-field-1"> Download Sample Format</a>
                                    </div>
                                </div>
                        </div>
                    </div>
        ...
        if ($("#formImport").length > 0) {
            $("#formImport").validate({
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url('modulpayroll/syncron/import') ?>",
                        data: formdata,
                        processData: false,
                        contentType: false,
                        cache: false,
                        ...
                        success: function(data) {
                            ...
                            if (data == 1 || data == true) {
                                ...
                                document.getElementById("formImport").reset();
                                swalInputFailed();
                                // window.location.href='<?php echo base_url("modulpayroll/syncron"); ?>';
                            }
                        }
                    });
                    return false;
