                ...
                <div class="col-xs-12">
                    ...
                    <div>
                                    ...
                                    <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
                                        <div class="inline position-relative">
                                            <a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
                                                <span class="white"><?php echo $this->session->userdata('kodekaryawan'); ?></span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            <a href="<?php echo base_url() . 'modulkasir/profile/edit'; ?>" class="btn btn-xs btn-success" title="Edit" data-id=15>Edit Profile</a>
                        </div>
                    </div>
