                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-6"> -->
                            <input type="hidden" id="uts_uas" name="uts_uas" placeholder="UTS / UAS" class="form-control" />
                            <!-- </div>
                            </div> -->
                            <div class="form-group">
    ...
    if ($("#formTambah").length > 0) {
        $("#formTambah").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('tahun_akad3/simpan') ?>",
                    type: "POST",
    ...
    if ($("#formEdit").length > 0) {
        $("#formEdit").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('tahun_akad3/update') ?>",
                    type: "POST",
...
<script type="text/javascript">
    ...
    $('#show_data').on('click', '.item_edit', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('tahun_akad3/tampil_byid') ?>",
            async: true,
            dataType: "JSON",
            data: {
                id: id,
